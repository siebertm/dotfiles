...
if !exists('loaded_multvals')
  echomsg 'genutils: You need a newer version of multvals.vim plugin (not loaded)'
  finish
endif
if loaded_multvals < 305
  echomsg 'genutils: You need a newer version of multvals.vim plugin (loaded, but version is to small)'
  finish
endif
